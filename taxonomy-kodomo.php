...
<div id="content" class="content-work">
	<div class="inner">
		...
		<main id="primary">
			<!-- breadcrumb -->
			<?php echo get_template_part('include/breadclumb'); ?>
			<!-- /breadcrumb -->

			<!--タクソノミー-->
			<div class="genre-nav">
				<div class="genre-nav-link"><a class="is-active"
						href="<?php echo esc_url( get_post_type_archive_link( 'reserve' ) ); ?>">すべて</a></div>
				<!-- /.genre-nav-link -->
				<?php
            ...
            ?>
				<div class="genre-nav-link"><a
						href="<?php echo esc_url( get_term_link( $genre_term, 'reserve' ) ); ?>"><?php echo esc_html( $genre_term->name ); ?></a>
				</div><!-- /.genre-nav-link -->
				<?php
                endforeach;
            ?>
