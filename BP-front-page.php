...
<div id="js-mv" class="mv mv__inner">
	<div class="mv__box">
		<div class="mv__top">
			<h2 class="mv__ttl">
				<img class="wow fadeInLeft" data-wow-duration="2s"
					src="<?php echo get_theme_file_uri(); ?>/assets/images/mv-txt-top.png" alt="">
			</h2>
			<p class="mv__txt">
				<img class="wow fadeInLeft" data-wow-duration="3s"
					src="<?php echo get_theme_file_uri(); ?>/assets/images/mv-txt-bottom.png" alt="">
			</p>
		</div>
		<div class="mv__content">
			<div class="mv__img  wow fadeInRight" data-wow-duration="3s"></div>
		</div>
		<div class="mv__content--sp">
			<div class="mv-button">
				<a href="https://park.paa.jp/park2/clinics/1460/businesses/01" target="_blank" rel="noopener" class="tel-btn">
					ネットで受付
					<span>▶︎ アイチケットへ</span>
				</a>
				<a href="https://lin.ee/kRbXNLH" target="_blank" rel="noopener" class="line-btn">
					LINEに登録
					<span>▶︎ 公式LINE</span>
				</a>
			</div>
			<div class="mv__img  wow fadeInRight" data-wow-duration="3s">
				<img src="<?php echo get_theme_file_uri(); ?>/assets/images/clinic-tsumiki.jpg" alt="Image">
			</div>
		</div>
	</div>
</div><!-- /.mv -->
...
<section id="line" class="line inner wow fadeInUp" data-wow-delay=".4s">
	<div class="section__inner">
		...
		<p class="line__txt">定期ワクチン等についてもお知らせしています。</p>
		<div class="line__box">
			<div class="line__box-left">
				<img src="<?php echo get_theme_file_uri(); ?>/assets/images/line-girl.png" alt="">
			</div>
		...
		<ul class="card__list">
			<li class="card__item">
				...
				<div class="btns-center">
					<a href="/kodomo/" class="rounded-btn deg rounded-btn--large btn-main-bg">詳しくはこちら</a>
				</div>
			</li>
			<li class="card__item">
				...
				<div class="btns-center">
					<a href="/yobou/" class="rounded-btn deg rounded-btn--large btn-main-bg">詳しくはこちら</a>
				</div>
			</li>
			<li class="card__item">
				...
				<div class="btns-center">
					<a href="/infants/" class="rounded-btn deg rounded-btn--large btn-main-bg">詳しくはこちら</a>
				</div>
			</li>
		</ul>
	...
	<div class="section__inner">
		...
		<table class="table-wrap">
			<tbody>
				...
				<tr>
					<td class="light">8:45 ~<br> 12:00</td>
					<td>○</td><!-- 月 -->
					<td>○</td><!-- 火 -->
					<td>○</td><!-- 水 -->
					<td>○</td><!-- 木 -->
				...
				<tr>
					<td class="light">13:30 ~ <br class="sp">14:00</td>
				...
				<tr>
					<td class="light">14:00 ~<br class="sp"> 17:30</td>
					<td>○</td><!-- 月 -->
					<td>○</td><!-- 火 -->
					<td>○</td><!-- 水 -->
					<td>○</td><!-- 木 -->
		...
		<div class="schedule__box">
			...
			<div>
				<?php if( get_field('closed-days-image', 830) ): ?>
				<img src="<?php the_field('closed-days-image', 830); ?>" />
				<?php endif; ?>
			</div>
			<!-- <p class=" g-map">
		...
		<ul class="blog__list">
			...
			<li class="blog__list-item">
				<a href="<?php the_permalink(); ?>" class="blog__card">
					...
					<p class="blog__card-datetime"><time datetime=”<?php the_time('c'); ?>”><?php the_time('Y/n/j'); ?></time>
					</p>
				</a>
				<div class="btns-center">
					<a href="<?php the_permalink(); ?>" class="rounded-btn deg rounded-btn--large btn-main-bg">詳しくはこちら</a>
				</div>
			</li>
			<?php endwhile;
                    endif; ?>
