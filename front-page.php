	...
	<div class="section__inner">
        ...
        ?>
			<li class="blog__list-item">
				...
				<div class="btns-center">
					<a href="<?php the_permalink(); ?>" class="rounded-btn rounded-btn--large btn-main-bg slide">読んでみる</a>
				</div>
			</li>
			<?php endwhile;
                    endif; ?>
		...
		<a href="<?php echo esc_url(get_permalink(get_option('page_for_posts'))); ?>" class="news-link">&raquo;ブログ記事一覧</a>
